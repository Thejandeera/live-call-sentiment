...
start "Sentiment Service" cmd /k "call venv\Scripts\activate && cd service-sentiment && uvicorn main:app --port 8003 --reload"

REM Start Sentiment Score Calculation Service (Port 8004)
start "Sentiment Score Service" cmd /k "call venv\Scripts\activate && cd service-score && uvicorn main:app --port 8004 --reload"
